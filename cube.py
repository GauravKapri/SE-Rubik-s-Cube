...
class Rubic_Cube:
    def __init__(self):
        ...
        angle = [
            (0, vector(0, 0, 0)),
            (np.pi / 2, vector(0, 1, 0)),
            (0, vector(0, 0, 0)),
            (np.pi / 2, vector(0, 1, 0)),
            (np.pi / 2, vector(1, 0, 0)),
            (np.pi / 2, vector(1, 0, 0)),
        ]
        # sides
    ...
    def animations(self):
        if self.rotate[0] == "front_counter":
            ...
            for tile in pieces:
                tile.rotate(
                    angle=(self.dA), axis=vector(0, 0, 1), origin=vector(0, 0, 0)
                )
            ...
            for tile in pieces:
                tile.rotate(
                    angle=(self.dA), axis=vector(1, 0, 0), origin=vector(0, 0, 0)
                )
            self.rotate[1] += self.dA
            ...
            for tile in pieces:
                tile.rotate(
                    angle=(self.dA), axis=vector(0, 1, 0), origin=vector(0, 0, 0)
                )
            self.rotate[1] += self.dA
        ...
        if (
            ...
            and self.rotate[1] - self.dA / 2 < self.rotate[2]
        ):
            self.rotate = [None, 0, 0]
